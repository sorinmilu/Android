...
public class NotificationsViewModel extends ViewModel {
    ...
    public void fetchCocktailData() {
        ...
        Log.i("NotificationViewModel", "Fetching cocktail data.");
        // Create the request
...
//        client = new OkHttpClient();
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    Log.i("NotificationViewModel", instructions);
                    // Ingredients
                    ...
                    for (int i = 1; i <= 15; i++) {
                        ...
                        Log.i("NotificationViewModel ingredient", ingredient);
                        Log.i("NotificationViewModel measure", measure);
                    ...
                    Log.i("NotificationViewModel", cocktailData.name);
    ...
    private void postSuccess(CocktailData cocktailData) {
        ...
        Log.i("NotificationViewModel", "post success here");
